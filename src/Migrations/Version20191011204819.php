 ...
 */
final class Version20191011204819 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vote (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, idea_id INTEGER NOT NULL, pour INTEGER DEFAULT NULL, contre INTEGER DEFAULT NULL)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5A1085645B6FEF7D ON vote (idea_id)');
        $this->addSql('ALTER TABLE idea ADD COLUMN date_creation DATETIME NOT NULL');
    }
